	...
	<div class="main-column">
      ...
      <?php if ( !$success && $action != 'resetpass' ): ?>
	      <ul class="tabs cf" id="login-tabs">
		      <li class="<?php if ($action == 'login') echo 'active-tab'; ?>"><a href="/login?action=login">Login</a></li>
		      <li class="<?php if ($action == 'register') echo 'active-tab'; ?>"><a href="/login?action=register">Register</a></li>
		      <li class="<?php if ($action == 'forgot') echo 'active-tab'; ?>"><a href="/login?action=forgot">Forgot?</a></li>
	      </ul>
      <?php endif; ?>

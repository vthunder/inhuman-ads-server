...
<ol class="contribute-instructions">
  ...
  <li>Use <a href="https://screenshots.firefox.com/">Firefox Screenshots</a> to capture the worst ads you can find<br>Tip: click '...' to the right of the URL bar and select "Take a Screenshot"</li>
  <li>Save the screenshot and click “Send to Inhuman Ads”.</li>
</ol>
[/ua_fx]
